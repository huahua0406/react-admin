            ...
            <div>
                {
                    icons.map(item => {
                        return (
                            <Card title={item.title} key={item.title} style={styles.cardStyle}>
                                {
                                    item.list.map(icon => {
                                        return (
                                            <Card.Grid style={styles.gridStyle} key={icon}>
                                                <Icon type={icon} style={styles.iconStyle}/><span>{icon}</span>
                                            </Card.Grid>
                                        )
                                    })
                                }
